...
// "./src/..."
#include "../File/Log.h"    // Inline errors, warnings, etc message management
...
enum class uArc
{
  Spins,              //! Using base 1 for rotation ratios: 1.0 %= 0.0
  Spin = Spins,       //! Using base 1 for rotation ratios: 1.0 %= 0.0
  Revolutions = Spin, //! Using base 1 for rotation ratios: 1.0 %= 0.0
  Revolution = Spin,  //! Using base 1 for rotation ratios: 1.0 %= 0.0
  Rev = Spins,        //! Using base 1 for rotation ratios: 1.0 %= 0.0
  S = Spin,           //! Using base 1 for rotation ratios: 1.0 %= 0.0
  Radians,            //! Using base pi for geometric measures: 3.14159 %= 0.0
  Radian = Radians,   //! Using base pi for geometric measures: 3.14159 %= 0.0
  Rad = Radian,       //! Using base pi for geometric measures: 3.14159 %= 0.0
  R = Rad,            //! Using base pi for geometric measures: 3.14159 %= 0.0
  Degrees,            //! Using base 360 for many factors: 360.0 %= 0.0
  Degree = Degrees,   //! Using base 360 for many factors: 360.0 %= 0.0
  Deg = Degree,       //! Using base 360 for many factors: 360.0 %= 0.0
  D = Degrees,        //! Using base 360 for many factors: 360.0 %= 0.0
  Gradians,           //! Using base 400 for decimal factors: 400.0 %= 0.0
  Gradian = Gradians, //! Using base 400 for decimal factors: 400.0 %= 0.0
  Grad = Gradian,     //! Using base 400 for decimal factors: 400.0 %= 0.0
  G = Grad,           //! Using base 400 for decimal factors: 400.0 %= 0.0
  Quadrevs,           //! Using base 4 for integer critical points: 4.0 %= 0.0
  Quadrev = Quadrevs, //! Using base 4 for integer critical points: 4.0 %= 0.0
  Quads = Quadrev,    //! Using base 4 for integer critical points: 4.0 %= 0.0
  Q = Quads           //! Using base 4 for integer critical points: 4.0 %= 0.0
}; // end uArc enum                                                           */
...
enum class uArcConv
{
  ...
  SpinsToQuadrevs,
  RevolutionsToQuadrevs = SpinsToQuadrevs,
  RevToQuad = SpinsToQuadrevs,
  SToQ = SpinsToQuadrevs,
  RadiansToSpins,
...
/**
@brief
  - check if value of the given unsigned is null (0u) for exception checks
@param value
  - input value to be checked for 0 value
@return
  - whether value is equal to null 0u value
*/
inline bool Is0B(u1 value);

/**
@brief
  - check if value of the given integer is null (0) for exception checks
@param value
  - input value to be checked for 0 value
@return
  - whether value is equal to null 0 value
*/
inline bool Is0C(s2 value);

/**
@brief
  - check if value of the given float is approximately null (0.0)
@param value
  - input value to be checked for relative 0 value
@return
  - whether value lies between + or - an infinitesimal episilon of 0.0
*/
inline bool Is0D(const f8& value);

/**
@brief
  - check if value of the given float is approximately null (0.0f)
@param value
  - input value to be checked for relative 0 value
@return
  - whether value lies between + or - an infinitesimal episilon of 0.0
*/
inline bool Is0F(f4 value);
...
@return
  - whether value is equal to null 0 value
*/
inline bool Is0L(const s8& value);
...
@return
  - whether value is equal to null 0u value
*/
inline bool Is0UL(const u8& value);
...
@return
  - whether value is equal to null 0u value
*/
inline bool Is0US(u2 value);


/**
@brief
  - check if value of the given unsigned is unitary (1u)
@param value
  - input value to be checked for 1 value
@return
  - whether value is equal to unit 1u value
*/
inline bool Is1B(u1 value);

/**
@brief
  - check if value of the given integer is unitary (1)
@param value
  - input value to be checked for 1 value
@return
  - whether value is equal to unit 1 value
*/
inline bool Is1C(s2 value);

/**
@brief
  - check if value of the given float is approximately unitary (1.0)
@param value
  - input value to be checked for approximate 1.0 value
@return
  - whether value lies between + or - an infinitesimal episilon of 1.0
*/
inline bool Is1D(const f8& value);

/**
@brief
  - check if value of the given float is approximately unitary (1.0f)
@param value
  - input value to be checked for approzimate 1.0f value
@return
  - whether value lies between + or - an infinitesimal episilon of 1.0f
*/
inline bool Is1F(f4 value);
...
@return
  - whether value is equal to unit (1) value
*/
inline bool Is1L(const s8& value);
...
@return
  - whether value is equal to unit 1u value
*/
inline bool Is1UL(const u8& value);
...
@param value
  - input value to be checked for 1 value
@return
  - whether value is equal to unit 0u value
*/
inline bool Is1UM(um value);
...
@return
  - (1.0f / (f4)value) given unless value is exactly 0 (otherwise infinity)
*/
...
@return
  - the closest integer to mixed ratio from initial to terminal values
*/
inline s2 LerpC(s2 from, s2 to, f4 mix);
...
@return
  - reference to the passed in value to continue with inline operations
*/
inline s2& SetInC(s2& value, s2 max, s2 min);
...
*/
inline s2 SubC(s1 current, s1 minus, OFlow policy = OFlowPolicy());
...
inline bool Is0B(u1 value)
{ return (value == 0u); } // end bool Is0B(u1)                                */
inline bool Is0C(s2 value)
{ return (value == 0); } // end bool Is0C(s1)                                 */
inline bool Is0D(const f8& value)
{ return IsInD(value, _INF, -_INF); } // end bool Is0D(const f8&)             */
inline bool Is0F(f4 value)
{ return IsInF(value, _INf, -_INf); } // end bool Is0F(f4)                    */
inline bool Is0(s4 value)
{ return (value == 0); } // end bool Is0(s4)                                  */
inline bool Is0L(const s8& value)
{ return (value == 0l); } // end bool Is0L(const s8&)                         */
inline bool Is0S(s2 value)
{ return (value == 0); } // end bool Is0S(s2)                                 */
inline bool Is0U(u4 value)
{ return (value == 0u); } // end bool Is0U(u4)                                */
inline bool Is0UL(const u8& value)
{ return (value == 0ul); } // end bool Is0UL(const u8&)                       */
inline bool Is0UM(um value)
{ return (value == 0u); } // end bool Is0UM(um)                               */
inline bool Is0US(u2 value)
{ return (value == 0u); } // end bool Is0US(u2)                               */

inline bool Is1B(u1 value)
{ return (value == 1u); } // end bool Is1B(u1)                                */
inline bool Is1C(s2 value)
{ return (value == 1); } // end bool Is1C(s1)                                 */
inline bool Is1D(const f8& value)
{
  constexpr f8 SUP = 1.0 + _INF, SUB = 1.0 - _INF;
  return IsInD(value, SUP, SUB);
} // end bool Is1D(const f8&)                                                 */
inline bool Is1F(f4 value)
{
  constexpr f4 SUP = If + _INf, SUB = If - _INf;
  return IsInF(value, SUP, SUB);
} // end bool Is1F(f4)                                                        */
inline bool Is1(s4 value)
{ return (value == 1); } // end bool Is1(s4)                                  */
inline bool Is1L(const s8& value)
{ return (value == 1l); } // end bool Is1L(const s8&)                         */
inline bool Is1S(s2 value)
{ return (value == 1); } // end bool Is1S(s2)                                 */
inline bool Is1U(u4 value)
{ return (value == 1u); } // end bool Is1U(u4)                                */
inline bool Is1UL(const u8& value)
{ return (value == 1ul); } // end bool Is1UL(const u8&)                       */
inline bool Is1UM(um value)
{ return (value == 1u); } // end bool Is1UM(um)                               */
inline bool Is1US(u2 value)
{ return (value == 1u); } // end bool Is1US(u2)                               */
...
inline s2 LerpC(s2 initial, s2 terminal, f4 mix)
{
  return initial + RoundF(mix * static_cast<f4>(terminal - initial));
...
inline s2 SubC(s1 current, s1 minus, OFlow policy)
{
  s1 prior = current;
  try
  {
