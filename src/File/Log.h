...
// "./src/..."
#include "../File/ASCIIPath.h"  // File path parameters for log file setting functions
...
namespace dp //! Contents for use within DigiPen MAT (& CS) class assignments
{
  ...
  public:
    ...
    */
    ...
    /**
    @brief
      Set the output file to be used for all system message logs
    @param file
      - path to the desired log file for all output
    @return
      - true if the file path can be set as requested
    ...
    */
    static void StreamPrefix(const std::string& errorPrefix = "",
