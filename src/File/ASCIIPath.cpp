...
#include "../File/ASCIIPath.h"  // Class header declarations file
#include "../Util/ASCIIValue.h" // Character manipulation operations
#include "../File/Log.h"        // Logging of messages expressing program operations
#include "../Extern/dirent.h"   // Directory content read; system path fallback scans
