...
namespace dp //! Contents for use within DigiPen MAT (& CS) class assignments
{
  ...
  public:
    ...
    struct {
      f4 l;  //! Value range minimum scale
      f4 h;  //! Value range maximum scale
    };
    struct {
      f4 lo;  //! Value range minimum scale
      f4 hi;  //! Value range maximum scale
    };
    struct {
      f4 low; //! Value range minimum scale
      f4 high;//! Value range maximum scale
    };
    struct {
