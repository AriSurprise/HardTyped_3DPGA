...
#include "../Math/v2f.h"      // Swizzling truncation to lower dimension vectors
#include "../Math/v3f.h"      // Class declaration header
#include "../Math/v4f.h"      // Swizzling & promotion to larger dimension vectors
