...
#include "../Math/nCr.h"        // Pascal triangle values
#include "../Math/pNom.h"       // Class declaration header
#include "../Util/ASCIIValue.h" // Variable label evaluation as pattern conformant
