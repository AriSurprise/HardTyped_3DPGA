...
#include "../Math/m2f.h"    // Minor determinant calculation taking m2f method
#include "../Math/m3f.h"    // Associated class declaration header
#include "../Math/m4f.h"    // Data promotion from 3x3 -> 4x4 affine data
#include "../Math/Stats.h"  // Sampling struct to iterate over vertex / data lists
#include "../Util/Value.h"  // Basic numerical operations: clamp, swap, min, max, etc
#include "../Math/v2u.h"    // Index [min, max] ranges of read in vertex list data
