...
#include "../Type/ang.h"        // Rotation class to use to set default angles
...
namespace dp //! Contents for use within DigiPen MAT (& CS) class assignments
{
  ...
  public:
    ...
    */
    mNf(u2 dimens = 2, f4 scalar = 1.0f);
    ...
    */
    ...
    @return
      - determinant of the subset matrix discluding row and col
    */
    f4 MinorDet(u2 row, u2 col) const;
    ...
    */
    ...
    @return
      - reference to the modified matrix for easier subsequent inline action
    */
    mNf& Resize(u2 squareDimensions, f4 traceVal = 1.0f, f4 elseVal = 0.0f);
    ...
    */
    const vNf& operator[](um subscript) const;
