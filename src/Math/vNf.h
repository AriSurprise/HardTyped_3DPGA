...
namespace dp //! Contents for use within DigiPen MAT (& CS) class assignments
{
  ...
  public:
    ...
    */
    vNf(um dimensions = 0, f4 value = 0.0f);
    ...
    */
    ...
    @param init
      - variadic list of values to populate vector with from 0 index, upwards
    */
    vNf(std::initializer_list<f8> init);
    ...
    */
    inline const um& Dimens(void) const
    { return dimens; } // end const um& Dimens(void) const                    */
    ...
    */
    ...
    @return
      - reference to the modified vNf for easier subsequent inline action
    */
    vNf& Resize(um dimensions, f4 value = 0.0f);
    ...
    */
    const f4& operator[](um index) const;
