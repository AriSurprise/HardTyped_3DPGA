...
// "./src/..."
#include "../Math/C010.h"       // Complex number class for base vector dimension terms
...
namespace dp //! Contents for use within DigiPen MAT (& CS) class assignments
{
  ...
  public:
    ...
    */
    vNc(std::initializer_list<C010> init);
    ...
    */
    C010 InnerProduct(const vNc& other) const;
    ...
    */
    const C010& operator[](size_t index) const;
    ...
    */
    C010 operator*(const vNc& other) const;
