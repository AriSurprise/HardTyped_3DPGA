...
// "./src/..."
#include "../Util/ASCIIValue.h" // character input validation of subscript operator
#include "../Util/Value.h"      // Primitive basic manipulator functions; clamping
...
namespace dp //! Contents for use within DigiPen MAT (& CS) class assignments
{
  ...
  public:
    ...
    struct {
      u4 l; //! Minimal unsigned value in v2u's [0] subscript
      u4 h; //! Maximal unsigned value in v2u's [1] subscript
    };
    struct {
      u4 lo; //! Minimal unsigned value in v2u's [0] subscript
      u4 hi; //! Maximal unsigned value in v2u's [1] subscript
    };
    struct {
      u4 low;   //! Minimal unsigned value in v2u's [0] subscript
      u4 high;  //! Maximal unsigned value in v2u's [1] subscript
    };
    struct {
    ...
    */
    ...
    /** Get the product of the contained field values (subscripts [0]*[1])
    @brief
      - get the product of the contained field values (subscripts [0]*[1])
    @return
      - product of this v2u's row and col element values (subscripts [0]*[1])
    */
    inline um Area(void) const
    { return Product(); } // end u4 v2u::Area(void) const                     */
    ...
    */
    ...
    /** Get this v2u's range or member value difference (subscripts [1]-[0])
    @brief
      - get this v2u's range or member value difference (subscripts [1]-[0])
    @brief
      - v2u members are not assured in ascending order: range may be negative
    @return
      - difference of this v2u's max and min values (subscripts [1]-[0])
    */
    inline u4 Difference(void) const
    { return max - min; } // end u4 v2u::Difference(void) const               */
    ...
    @return
      - difference of this v2u's max and min values (subscripts [1]-[0])
    */
    inline u4 Distance(void) const
    { return Difference(); } // end u4 v2u::Distance(void) const              */


    /**
    @brief
      - format a v2u for being output as a dimensional RowxCol string
    @return
      - ASCII character text set to row and col with intermember x inserted
    */
    inline std::string DimenStr(void) const
    {
      return std::to_string(a) + "x" + std::to_string(b);
    } // end std::string v2u::DimenStr(void) const                            */
    ...
    */
    ...
    @brief
      - get the product of the contained field values (subscripts [0]*[1])
    @return
      - product of this v2u's member element values (subscripts [0]*[1])
    */
    inline um Product(void) const
    { return first * second; } // end u4 v2u::Product(void) const             */
    ...
    @return
      - difference of this v2u's max and min values (subscripts [1]-[0])
    */
    inline u4 Range(void) const
    { return Difference(); } // end u4 v2u::Range(void) const                 */


    /** Get this v2u's member value ratio (subscripts [0]/[1])
    @brief
      - get this v2u's range or member value difference (subscripts [1]-[0])
    @brief
      - v2u members are not assured in ascending order: range may be negative
    @return
      - difference of this v2u's max and min values (subscripts [1]-[0])
    */
    inline f4 Ratio(void) const
    {
      return static_cast<f4>(min) * InvU(max);
    } // end u4 v2u::Ratio(void) const                                        */
    ...
    */
    ...
    /** Get the sum of the contained field values (subscripts [0]+[1])
    @brief
      - get the sum of the contained field values (subscripts [0]+[1])
    @return
      - sum of this v2u's first and second element values (subscripts [0]+[1])
    */
    inline u4 Sum(void) const
    { return first + second; } // end u4 v2u::Sum(void) const                 */


    /**
    @brief
      - set first and second fields to be interchanged (subscripts [0]<->[1])
    @return
      - reference to the modified v2u for easier subsequent inline action
    */
    v2u& Swap(void);
    ...
    */
    inline v2u& operator=(v2u&& result) noexcept
    {
      Set(result);
      return *this;
    } // end v2u& v2u::operator=(v2u&&) noexcept                              */
    ...
    */
    inline const u4& operator[](s2 channel) const
    {
      // clamp wildly out of range values into lowest 2 unsigned values
      if (!isascii((s1)channel) || (channel<0x20 && channel>0xF))
      { channel &= 1; }
    ...
    } // end const u4& v2u::operator[](s2) const                              */
