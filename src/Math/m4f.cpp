...
#^^^^^^^^#^^^^^^^^^#^^^^^^^^^#^^^^^^^^^#^^^^^^^^^#^^^^^^^^^#^^^^^^^^^#^^^^^^^^*/
#pragma once
#include "../Math/m4f.h"    // Associated class declaration header
...
#include "../Math/m3f.h"    // Linear 3x3 components read as extracted object
#include "../Math/v2f.h"    // 2D data for doubly promoted m4f & [min, max] ranges
#include "../Math/v3f.h"    // 3D point / vector data for homogeneous matrices
