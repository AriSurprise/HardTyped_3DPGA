...
// "./src/..."
#include "../Type/ang.h"    // Angle unit wrapper to set via angle defaults
#include "../Type/Errata.h" // Primitive aliases for brevity, portability
#include "../Math/v3f.h"    // Member[] instantiation needs exposed visibility
#include "../Math/vSpace.h" // Enums; argument defaults for planes, 2/3D coords
